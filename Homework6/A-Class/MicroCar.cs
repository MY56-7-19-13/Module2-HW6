...
namespace Homework6.A_Class
{
    public class MicroCar : AClass
    {
        ...
        public MicroCar(string brand, string model, int price, string level, double fuelConsuption, int year, double engine, string type, int doors, int seats, string wheelDrive, string color, string country)
