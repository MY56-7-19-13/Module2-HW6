...
namespace Homework6.D_Class
{
    public class CompactExecutiveCar : DClass
    {
        private int _doors;
        private int _seats;
        ...
        public CompactExecutiveCar(string brand, string model, int price, string level, double fuelConsuption, int year, double engine, string type, int doors, int seats, string wheelDrive, string color, string country)
