...
{
    public class Convertible : SClass
    {
        ...
        public Convertible(string brand, string model, int price, string level, double fuelConsuption, int year, double engine, string type, int doors, int seats, string wheelDrive, string personalDriver, string color, string country)
