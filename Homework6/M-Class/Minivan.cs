...
namespace Homework6.M_Class
{
    public class Minivan : MClass
    {
        ...
        public Minivan(string brand, string model, int price, string level, double fuelConsuption, int year, double engine, string type, int doors, int seats, string wheelDrive, double longitude, string color, string country)
